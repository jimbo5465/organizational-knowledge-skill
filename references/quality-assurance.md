...
```
الف. وضعیت کلی: قبول / نیازمند بازبینی / رد
ب. امتیازهای کیفیت: دقت / کاملبودن / شفافیت / قابلیت ردیابی / آمادگی ثبت (0–5)
پ. مسائل حیاتی: ...
ت. مسائل مهم: ...
ث. مسائل متوسط: ...
ج. مسائل جزئی: ...
...
خ. مسائل طبقهبندی: ...
د. تناقضها: ...
ذ. اقدامات اپراتور: اصلاح خودکار / بازبینی اپراتور / ورودی اپراتور الزامی / راستیآزمایی منبع الزامی
ر. تصمیم نهایی QA: قبول / نیازمند بازبینی / رد
```
